  ...
  return (
    <div>
      ...
      <div className="flex1">
          ...
          <div><NavLink to="/jobs" style={({ isActive }) => { return {color: isActive ? "blue" : "Black",textDecoration: "none",} }}> Jobs </NavLink></div>
          <div><NavLink to="/nature" style={({ isActive }) => { return {color: isActive ? "blue" : "Black",textDecoration: "none",} }}> Nature </NavLink></div>    
